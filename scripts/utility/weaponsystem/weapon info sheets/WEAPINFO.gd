...
@export var position : Vector3 = Vector3(0.6, -0.3, -0.5) ##Offset from camera center in L/R, U/D, F/B
@export var rotation : Vector3 = Vector3(0, 0, 0) ##In case the model is weird, custom held rotation
